...
This package provides an implementation of the Cascade Support Vector Machine Classifier, as proposed in [Graf, H., Cosatto, E., Bottou, L., Dourdanovic, I., & Vapnik, V. (2004)](https://leon.bottou.org/publications/pdf/nips-2004c.pdf).
